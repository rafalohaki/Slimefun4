...
public class SlimefunGuideItem extends ItemStack {
    ...
    public SlimefunGuideItem(@Nonnull SlimefunGuideImplementation implementation, @Nonnull String name) {
        ...
        lore.add(type == SlimefunGuideMode.CHEAT_MODE ? ChatColors.color("&4&lTylko dla administratorów") : "");
        lore.add(ChatColors.color("&ePPM &8\u21E8 &7Przeglądaj przedmioty"));
        lore.add(ChatColors.color("&eShift + PPM &8\u21E8 &7Ustawienia / Informacje"));
